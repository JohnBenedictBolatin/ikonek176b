                    ...
                    <div class="profile-content-container">
                        ...
                        <div class="profile-details-card">
                            <div class="profile-photo-section">
                                <img src="/assets/KAPITAN.jpg" alt="User Photo" class="profile-photo" />
                                <button class="edit-profile-btn">EDIT PROFILE</button>
                            </div>
                            <div class="profile-info-section">
                                <h3 class="profile-display-name">Kap. Sammy Reyes</h3>
                                <div class="profile-badge">BARANGAY OFFICIAL</div>
                                <p class="profile-description">
                                    Ako po ay nakatira sa Bagong Silang, Caloocan City, at isang Barangay Captain sa Barangay 176B . Mahilig ako makisama sa mga aktibites ng komunidad at tumutulong sa mga makabuluhang programa.
                                </p>
