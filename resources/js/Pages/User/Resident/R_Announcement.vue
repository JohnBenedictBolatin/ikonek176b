                    ...
                    <div class="post-detail-container" v-if="selectedPost">
                        ...
                        <div class="comments-section">
                            ...
                            <div class="add-comment-form">
                                <img src="/assets/DEFAULT.jpg" alt="Your Profile" class="comment-avatar" />
                                ...
                                >
                                    ...
                                    <div class="comment-content-wrapper">
                                        ...
                                        <div v-if="replyingTo === comment.id" class="reply-form">
                                            <img src="/assets/DEFAULT.jpg" alt="Your Profile" class="comment-avatar small" />
...
const navigateToDocuments = () => {
    ...
    router.visit(route('document_request_select_resident'))  // ✅ Correct
}
...
const viewComments = (postId) => {
    router.visit(route('announcement_clickpost_resident', { id: postId }))
}

const sharePost = (postId) => {
    const url = window.location.origin + route('announcement_clickpost_resident', { id: postId })
